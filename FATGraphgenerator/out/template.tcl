...
#important
    ...
    # HP-------------------------------------------------------------------------
    # this is a jugar to get rid of regenerating ftp traffic. do a proper fix later. 
    $ns at [expr $endTime + 0.0002] "$ns detach-agent $n0 $tcp" 
    $ns at [expr $endTime + 0.0002] "$ns detach-agent $n1 $snk"
    #--------------------------------------------------------------------------
